DELETE intern_ap.Oficii;
DELETE intern_ap.Angajati;
DELETE intern_ap.Companii;
--insertion in intern_ap.Oficii

INSERT INTO intern_ap.Oficii (Cod_oficiu ,Localitatea ,Regiunea )
...
---inserare in tabela intern_ap.Angajati
    
INSERT INTO intern_ap.Angajati (Cod_angajat ,Nume ,Prenume , Varsta, Functia, Cod_oficiu, Data_angajarii, Suma_planificata)
...
--UPDATE intern_ap.Oficii

UPDATE   intern_ap.Oficii  SET Cod_manager='ML' WHERE  Cod_oficiu='BL';

UPDATE   intern_ap.Oficii  SET Cod_manager='VD' WHERE  Cod_oficiu= 'C';

UPDATE   intern_ap.Oficii  SET Cod_manager='HI' WHERE  Cod_oficiu='CH';
   
UPDATE   intern_ap.Oficii  SET Cod_manager='ML' WHERE  Cod_oficiu='ED';
   
UPDATE   intern_ap.Oficii  SET Cod_manager='ML' WHERE  Cod_oficiu='GL';
   
UPDATE   intern_ap.Oficii  SET Cod_manager='LV' WHERE  Cod_oficiu='OR';
   
UPDATE   intern_ap.Oficii  SET Cod_manager='SD' WHERE  Cod_oficiu='RZ'; 
   
UPDATE   intern_ap.Oficii  SET Cod_manager='BN' WHERE  Cod_oficiu='SR';
   
UPDATE   intern_ap.Oficii  SET Cod_manager='VD' WHERE  Cod_oficiu='UN';
   

--insertion in intern_ap.Companii

INSERT INTO intern_ap.Companii (Cod_companie ,Compania ,Reprezentant_companie , Datoria )
...
-- insertion in intern_ap.Produse

INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Monitor LG 17"',100.00,'Y');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Monitor Samsung 15"',50.00,'F');   
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Televizor JVS 54cm',280.00,'F');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Procesor Pentium 4',130.00,'T');

INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Procesor Celeron 2000',125.00,'Y');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Mouse Genius optic',4.00,'F');   
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Mouse Logitech optic',5.00,'T');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Televizor Sony 72cm',485.00,'F'); 

INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'DVD Sony 50',75.00,'F');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'DVD Sony 32-16-32',135.00,'T');   
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'CD-R Benq 700MB',0.10,'T');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'CD-RW Benq 700MB',0.25,'T');

INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Tastiera Logitech alba',6.75,'T');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Tastiera Logitech neagra',9.75,'F'); 

INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Monitor Samsung 17"',85.50,'T');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Monitor Samsung 21"',109.50,'F');   
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Monitor Samtron 15"',35.50,'F');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Televizor Alfa 51cm',100.40,'T'); 

INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Televizor Polar 54cm',200.00,'F');   
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Filtru Sven 220V',3.75,'T');
    
INSERT INTO intern_ap.Produse (Cod_produs , Descriere ,Pret ,Exista)
    VALUES (INTERN_AP.PK_PRODUSE.NEXTVAL,'Telefon Siemens A55',85.00,'T');   

--insertion in intern_ap.Tranzactii

INSERT INTO intern_ap.Tranzactii (Data_comenzii ,Cod_client ,Cod_vanzator , Cod_produs, Cantitatea)
