...
SELECT COUNT(*) "Count"
FROM   TRANZACTII
WHERE  data_comenzii > TO_DATE('01-01-2005','DD-MM-YYYY') 
AND    data_comenzii < TO_DATE(' 28-02-2005','DD-MM-YYYY');
